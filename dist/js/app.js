(() => {
    ...
    let titleMenuSelect = function() {
        ...
        document.addEventListener("click", (function(e) {
            if (e.target.closest(".select__title")) selectOptions.classList.toggle("select__options_open"); else selectOptions.classList.remove("select__options_open");
        }));
    };
    titleMenuSelect();
    ...
    function subMenuShow(e) {
        if (e.target.closest(".menu-header__item_submenu") || e.target.closest(".header-submenu__body")) subMenu.classList.add("submenu-show"); else subMenu.classList.remove("submenu-show");
    }
