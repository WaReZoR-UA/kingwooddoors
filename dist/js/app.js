(() => {
    ...
    (() => {
        ...
        document.querySelector(".actions-header__english");
        document.querySelector(".actions-footer__english");
        document.querySelector(".actions-header__russian");
        document.querySelector(".actions-footer__russian");
        ...
        document.querySelector(".menu-header__item_submenu");
        document.querySelector(".menu-footer__item_submenu");
        document.addEventListener("click", subMenuShowClick);
        function subMenuShowClick(e) {
            if (e.target.closest(".menu-header__item_submenu")) subMenu.classList.toggle("submenu-show"); else subMenu.classList.remove("submenu-show");
